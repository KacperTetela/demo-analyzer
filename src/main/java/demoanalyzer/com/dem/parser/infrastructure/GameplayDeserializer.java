...
public class GameplayDeserializer {
  ...
  private Map<String, Class<? extends GameplayEvent>> initializeRecordTypeMap() {
    ...
    map.put("bomb", Bomb.class);
    map.put("damages", Damages.class);
    map.put("footsteps", Footsteps.class);
    map.put("grenades", Grenades.class);
    map.put("infernos", Infernos.class);
    map.put("kills", Kills.class);
    map.put("rounds", Rounds.class);
    map.put("shots", Shots.class);
    map.put("smokes", Smokes.class);
    map.put("ticks", Ticks.class);
