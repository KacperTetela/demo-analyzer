...
public class AuthenticationServiceImpl implements AuthenticationService {
  ...
  public UserResponseDto register(UserRequestDto userRequest) {
    AuthUser user = convertToUser(userRequest);
    AuthUser registeredUser = registerUser(user);
  ...
  public TokenResponseDto login(UserRequestDto userRequest) {
    AuthUser user = loginUser(userRequest.username(), userRequest.password());
  ...
  public AuthUser loginUser(String username, String password) {
    ...
    return new AuthUser(authUserEntity.getId(), authUserEntity.getEmail(), authUserEntity.getPassword());
  }
  ...
  private AuthUser convertToUser(UserRequestDto userRequest) {
    return new AuthUser(null, userRequest.username(), userRequest.password());
  }
}
